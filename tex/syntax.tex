...
Pro importování symbolu nám stačí použít klíčové slovo \irust{use}, za kterým napíšeme
cestu k~symbolu pomocí namespace operátorů \irust{::}. Nepotřebujeme žádné hlavičkové
soubory, stačí nám pouze soubory s~kódem. Při externím linkování se ale deklarováním
symbolů a funkcí bez těla nevyhneme.

V~následujícím příkladu importujeme typ \irust{LinkedList} z~modulu \irust{collections}
knihovny \irust{std}. Dále voláme metodu \irust{new} tohoto typu.
