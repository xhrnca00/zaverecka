...
tento trait (nikoliv přetížením \icpp{std::basic_istream& operator>>}).
...
Tohoto lze docílit buď klíčovým slovem \irust{where}, nebo dvojtečkovou syntaxí přímo
...
\begin{itemize}
    ...
    \item \irust{Error}~-- požadavky pro chyby (vypisovatelnost,\dots)
