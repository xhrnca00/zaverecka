...
\begin{literatura}
    ...
    \citace{thebook}{The Book}{\autor{KLABNIK, Steve} a \autor{Carol NICHOLS}. \nazev{The
            Rust programming language} [online]. 2nd Edition. San Francisco: No Starch Press,
        2023 [cit. 2023-06-06]. ISBN 9781718503106. Dostupné z:
        \url{https://doc.rust-lang.org/book/}}
    % TODO: std docs, cargo docs (maybe), rust by example?
