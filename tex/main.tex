...
}{Specifically, this thesis focuses on major changes in the style of programming (working
...
\abstrakt{Tato závěrečná práce představuje programovací jazyk Rust a některé jeho výhody
    oproti jazyku C++. Práce obsahuje ukázky syntaxe a nepředpokládá žádnou předchozí
    znalost Rustu.
